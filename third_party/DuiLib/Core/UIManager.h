...
/////////////////////////////////////////////////////////////////////////////////////
//
typedef void (CALLBACK* DUI_PAINT_CALLBACK)(HDC& hMemDc, HBITMAP hMemBmp, int width, int height);
...
{
public:
	interface CPaintManagerUI_PaintCallBack
	{
		virtual void  PM_PaintCallBack(HDC& hMemDc, int width, int height) = 0;
		virtual void  PM_FlashProc(HDC& hDc, HDC& hMemDc, HBITMAP hMemBmp, int width, int height) = 0;
	};
public:
    CPaintManagerUI();
    ~CPaintManagerUI();
...
public:
	...
	//
	bool m_bNeedFlash;
	CPaintManagerUI_PaintCallBack* m_pCall;
	void SetCallBack(CPaintManagerUI_PaintCallBack* pCall);
	void NeedFlashBkImage(bool bNeed){ m_bNeedFlash = bNeed; }
//
};
